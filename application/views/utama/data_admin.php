...
<div class="content-wrapper mt-3">
  ...
  <div class="container">
    ...
    <div class="card">
      <div class="card-body">
        <h3 style="font-weight: bold;">Data Admin</h3>
        <hr>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form method="post" action="<?= base_url('index/tambah_admin') ?>" enctype="multipart/form-data">
                    ...
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <form method="post" action="<?= base_url('index/hapus_admin') ?>">
